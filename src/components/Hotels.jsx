...
const Hotels = ({ item, loading }) => {
  ...
  return (
    <div className="text-black ">
      <div className="grid grid-cols-12 bg-white m-2 rounded-md shadow-custom-card text-[12px] space-x-3 border-[1px] p-2">
        <div className="flex col-span-9 space-x-3 md:col-span-10">
          <div className="grid items-start grid-cols-12 gap-3">
            <div className="col-span-5">
              <img src={item.photos[0]} className="" />
            </div>
            <div className="text-[12px] col-span-7 md:text-[14px] lg:text-[15px] space-y-0 md:space-y-1 lg:space-y-2">
              <h1
        ...
        <div className="flex flex-col justify-between col-span-3 md:col-span-2">
          {item.rating && (
